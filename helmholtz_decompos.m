...
if filt_flag==1
    [b, a] = butter(3, [f-0.20*f f+0.22*f]*(dt/pi),'stop');
...
figure
[AX, H1, H2] = plotyy(dist_axis/1000, sqrt(s2ll+s2tt)./dist_axis'/f, ...
    dist_axis/1000, s2tt./s2ll,'loglog','semilogx')
xlabel('r(km)')
ylabel(AX(1),'Ro = (\bf\delta u.\delta u\rm)^{0.5}/fr')
ylabel(AX(2),'D_{tt}/D_{ll}')
% H1.MarkerStyle = '-';
% H2.LineStyle = 'o-';
% ylabel('S_{tt}/S_{ll}')
% grid
set(AX(1),'Ylim', [7*10^-3 20],'Xlim',[10^-2 10^3],'fontsize',16)
set(AX(2),'Ylim', [0.5 2.2],'Xlim',[10^-2 10^3],'fontsize',16)
set(H1,'marker','+','linewidth',2)
set(H2,'marker','o','linewidth',2)
